...
(function () {
  ...
  const CONCEPT_LABELS = {
    ...
    prisme_aire_base: "Aire de la base d'un prisme",
    ...
    fraction_lire_figure: "Lire une fraction sur une figure",
    fraction_quantite: "Calculer une fraction d'une quantité",
    fraction_decimal_pourcentage: "Fraction, décimal et pourcentage",
